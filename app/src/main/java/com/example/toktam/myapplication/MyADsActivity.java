...
public class MyADsActivity extends MainActivity {
 /******************/
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    getLayoutInflater().inflate(R.layout.activity_my_ads,content_frame);
 /*****************/
...
if(!preferences.contains("mobile"))
{
 ...
 /***********************/
    ...
    setUpToolbar();
    //-----------------------------
    recyclerView = (RecyclerView) findViewById(R.id.my_recycler_ads);
    ...
    /************************************************/
    swipeRefreshLayout=(SwipeRefreshLayout)findViewById(R.id.swip_mylist);
...
public boolean onCreateOptionsMenu(Menu menu) {
  ...
  private void getJson() {
    ...
    String MY_URL = "http://10.0.2.2:80/fastsell/mylist.php";
    JSONObject jsonParams = new JSONObject();
    try {
      jsonParams.put("command", "get_my_ad_list");
